...
public class SOM implements Clusterer {
     ...
     *random generator
     *
     * use 9 for the figures
     * 
     * use 2 for predictions
     */
   public Random generator=new Random(2);
    /**
...
//            generator = new Random();
    ...
    public Dataset[] executeClustering(Dataset data) {
        ...
        // hexa || rect
        WeightVectors wV = new WeightVectors(xdim, ydim, data.instance(0).size(), gridType.toString());
        ...
        for (int i = 0; i < data.size(); i++) {
            clusters.get(labels.resolveIndexOfWinningNeuron(iV.getNodeValuesAt(i))).add(data.instance(i));
        }
